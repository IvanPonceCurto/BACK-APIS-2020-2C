...
exports.getEncuestasDeLaBDD = async function (req, res, next) {
    ...
    try {
        var Encuestas = await EncuestaService.getEncuestas({}, page, limit)
...
exports.createEncuesta = async function (req, res, next) {
    ...
    try {
        ...
        var createdEncuesta = await EmpresaService.createEncuesta(Encuesta)
        return res.status(201).json({token: createdEmpresa, message: "Encuesta creada correctamente"})
